...
export default function StatsSubpage() {
  ...
  /** When set, show GW points breakdown popup first; "Show Player Details" then opens full modal */
  ...
  useEffect(() => {
    if (breakdownForPlayer == null) return
    const prev = document.body.style.overflow
    document.body.style.overflow = 'hidden'
    return () => { document.body.style.overflow = prev }
  }, [breakdownForPlayer])
      ...
      {breakdownForPlayer != null && typeof document !== 'undefined' && createPortal(
        <StatsPlayerBreakdownPopup
          ...
          onShowFullDetail={() => {
            ...
            setBreakdownForPlayer(null)
          }}
          onClose={() => setBreakdownForPlayer(null)}
        />,
        document.body
      )}
